...
<html>
		...
		<div id="mainmenu" class="bluff-tooltip" style="right:0;border:solid;position:absolute;width:80%; height:85%;resize: both;overflow: auto;">
			...
			<?php
				...
				if(isset($result->num_rows)?$result->num_rows>0:0) 
				{
					...
					{
						echo "<tr>
						<td class='chead1' style='display:none; border: 1px solid #ddd;padding: 12px;text-align: center;'><input class='citem' type='checkbox' style='position:relative;'></td>";
	...
	<script>
		function addItem()
		{
			location.href = 'addItem.php?department=<?php echo "$department";?>';
		}
